...
- <a id="%24defs/Dataset"></a>**`Dataset`** *(object)*
  - <a id="%24defs/Dataset/properties/%24schema"></a>**`$schema`**: Must be: `"https://fairspec.github.io/fairspec-cardealer/profiles/0.2.0/dataset.json"`.
...
- <a id="%24defs/CarResource"></a>**`CarResource`** *(object)*
  ...
  - <a id="%24defs/CarResource/properties/tableSchema"></a>**`tableSchema`**: Must be: `"https://fairspec.github.io/fairspec-cardealer/schemas/0.2.0/car.json"`.
- <a id="%24defs/DealerResource"></a>**`DealerResource`** *(object)*
  ...
  - <a id="%24defs/DealerResource/properties/tableSchema"></a>**`tableSchema`**: Must be: `"https://fairspec.github.io/fairspec-cardealer/schemas/0.2.0/dealer.json"`.
- <a id="%24defs/ShowroomResource"></a>**`ShowroomResource`** *(object)*
  ...
  - <a id="%24defs/ShowroomResource/properties/tableSchema"></a>**`tableSchema`**: Must be: `"https://fairspec.github.io/fairspec-cardealer/schemas/0.2.0/showroom.json"`.
